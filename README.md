...
![](picture/0简介.jpeg)
* **左**：卸下机械盘，换 `SATA` 接口 SSD 和自带 32GB SSD 融合，上图左实际是自带 SSD 的速度，读写 3 次后会低至 100-300 MB/s，此时才是 `SATA` 接口 SSD 的速度，只能满足日常使用。【融合后 Final Cut Pro 卡，不融合 Photoshop 卡，个人遇到这个 BUG 真的恼火。】
